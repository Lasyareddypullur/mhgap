...
import './CDAProtocolsPage6.css'; // Import your CSS file

const CDAProtocolsPage6: React.FC = () => {
    ...
    <IonPage>
      ...
      <IonContent>
        <div className="content">
          <h2>PROTOCOL 6 (Emotional Disorders or Depression)</h2>
          <IonList>
            ...
            <IonItem button onClick={() => navigateTo('CDAProtocol1Page5')}>
              <IonLabel>Psycoeducation for emotional problems/disorders including depression in adolescents (2.5)</IonLabel>
              <IonIcon icon={arrowForwardOutline} slot="end" color="success" />
            </IonItem>
...
export default CDAProtocolsPage6;